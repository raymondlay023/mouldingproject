...
<head>
    ...
    <title>Form Bahan Baku Lainnya</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Form Bahan Baku Lainnya for Header {{ $header->id }}</h1>
        ...
        <form action="{{ route('form.2.store', $header->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" id="jumlah_pemakaian" name="jumlah_pemakaian" class="w-full border border-gray-300 p-2 rounded" required>
            </div>

            <!-- Biaya -->
            <div class="mb-4">
                <label for="biaya" class="block text-gray-700">Biaya:</label>
                <input type="number" step="0.01" id="biaya" name="biaya" class="w-full border border-gray-300 p-2 rounded" required>
            </div>

            <!-- Alokasi Produk -->
            <div class="mb-4">
                <label for="alokasi_produk" class="block text-gray-700">Alokasi Produk:</label>
                <input type="number" step="0.01" id="alokasi_produk" name="alokasi_produk" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
        </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 mt-4">
                <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b">Alokasi Produk</th>
                ...
                <tbody>
                    @foreach ($datas as $data)
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">{{ $data->biaya }}</td>
                            <td class="py-2 px-4 border-b">{{ $data->alokasi_produk }}</td>
