...
<head>
    ...
    <title>Form Biaya Tidak Langsung</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Form Biaya Tidak Langsung for Header {{ $header->id }}</h1>
        ...
        <form action="{{ route('form.8.store', $header->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                <label for="tkdn_kandungan" class="block text-gray-700">TKDN :</label>
                <input type="text" id="tkdn_kandungan" name="tkdn_kandungan" class="w-full border border-gray-300 p-2 rounded" required>
            </div>

            <div class="mb-4">
                <label for="jumlah" class="block text-gray-700">Jumlah :</label>
                <input type="text" id="jumlah" name="jumlah" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="alokasi_pengunaan" name="alokasi_pengunaan" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 mt-4">
                <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b">TKDN</th>
