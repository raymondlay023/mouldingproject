...
<head>
    ...
    <title>Form Mesin Sewa</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Form Mesin Sewa for Header {{ $header->id }}</h1>
        ...
        <form action="{{ route('form.7.store', $header->id) }}" method="POST">
            @csrf
            ...
            <!-- Jumlah Pemakaian -->
            <div class="mb-4">
                <label for="jumlah_unit" class="block text-gray-700">Jumlah Unit :</label>
                <input type="number" id="jumlah_unit" name="jumlah_unit" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 mt-4">
                <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b">Jumlah Unit</th>
                ...
                <tbody>
                    @foreach ($datas as $data)
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">{{ $data->jumlah_unit }}</td>
                ...
                <tfoot>
                    <tr>
                        <th colspan="9" class="py-2 px-4 border-t text-right">Total</th>
