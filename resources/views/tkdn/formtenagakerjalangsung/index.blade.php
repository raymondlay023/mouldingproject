...
<head>
    ...
    <title>Form Tenaga Kerja Langsung</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Form Tenaga Kerja Langsung for Header {{ $header->id }}</h1>
        ...
        <form action="{{ route('form.3.store', $header->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kewarganegaraan" name="kewarganegaraan" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            ...
            <!-- Jumlah Pemakaian -->
            <div class="mb-4">
                <label for="jumlah_orang" class="block text-gray-700">Jumlah Orang :</label>
                <input type="number" id="jumlah_orang" name="jumlah_orang" class="w-full border border-gray-300 p-2 rounded" required>
            </div>

            <!-- Biaya -->
            <div class="mb-4">
                <label for="gaji_perbulan" class="block text-gray-700">Gaji Perbulan:</label>
                <input type="number" step="0.01" id="gaji_perbulan" name="gaji_perbulan" class="w-full border border-gray-300 p-2 rounded" required>
            </div>

            <!-- Alokasi Produk -->
            <div class="mb-4">
                <label for="alokasi_gaji" class="block text-gray-700">Alokasi Gaji:</label>
                <input type="number" step="0.01" id="alokasi_gaji" name="alokasi_gaji" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
        </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 mt-4">
                <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b">Gaji Perbulan</th>
                        <th class="py-2 px-4 border-b">Alokasi Gaji</th>
                ...
                <tbody>
                    @foreach ($datas as $data)
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">{{ $data->jumlah_orang }}</td>
                            <td class="py-2 px-4 border-b">{{ $data->gaji_perbulan }}</td>
                            <td class="py-2 px-4 border-b">{{ $data->alokasi_gaji }}</td>
