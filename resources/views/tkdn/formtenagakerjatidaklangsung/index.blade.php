...
<head>
    ...
    <title>Form Tenaga Kerja Tidak Langsung</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Form Tenaga Kerja Tidak Langsung for Header {{ $header->id }}</h1>
        ...
        <form action="{{ route('form.5.store', $header->id) }}" method="POST">
            @csrf
            ...
            <!-- Jumlah Pemakaian -->
            <div class="mb-4">
                <label for="jumlah_orang" class="block text-gray-700">jumlah_orang :</label>
